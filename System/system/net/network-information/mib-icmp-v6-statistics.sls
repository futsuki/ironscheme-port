(library (system net network-information mib-icmp-v6-statistics)
  (export new
          is?
          mib-icmp-v6-statistics?
      ...
      (syntax-case e ()
        ((_ a ...)
         #'(clr-new
             ...
             ...)))))
  (define (is? a)
    (clr-is System.Net.NetworkInformation.MibIcmpV6Statistics a))
  (define (mib-icmp-v6-statistics? a)
    (clr-is System.Net.NetworkInformation.MibIcmpV6Statistics a))
  (define-field-port
    destination-unreachable-messages-received
    #f
