(library (system net network-information win32-ipglobal-statistics)
  (export new
          is?
          win32-ipglobal-statistics?
          default-ttl
          forwarding-enabled?
      ...
      (syntax-case e ()
        ((_ a ...)
         #'(clr-new
             ...
             ...)))))
  (define (is? a)
    (clr-is System.Net.NetworkInformation.Win32IPGlobalStatistics a))
  (define (win32-ipglobal-statistics? a)
    (clr-is System.Net.NetworkInformation.Win32IPGlobalStatistics a))
  (define-field-port
    default-ttl
    #f
