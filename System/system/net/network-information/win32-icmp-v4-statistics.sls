(library (system net network-information win32-icmp-v4-statistics)
  (export new
          is?
          win32-icmp-v4-statistics?
      ...
      (syntax-case e ()
        ((_ a ...)
         #'(clr-new
             ...
             ...)))))
  (define (is? a)
    (clr-is System.Net.NetworkInformation.Win32IcmpV4Statistics a))
  (define (win32-icmp-v4-statistics? a)
    (clr-is System.Net.NetworkInformation.Win32IcmpV4Statistics a))
  (define-field-port
    address-mask-replies-received
    #f
