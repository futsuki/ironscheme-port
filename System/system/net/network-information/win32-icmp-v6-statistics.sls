(library (system net network-information win32-icmp-v6-statistics)
  (export new
          is?
          win32-icmp-v6-statistics?
      ...
      (syntax-case e ()
        ((_ a ...)
         #'(clr-new
             ...
             ...)))))
  (define (is? a)
    (clr-is System.Net.NetworkInformation.Win32IcmpV6Statistics a))
  (define (win32-icmp-v6-statistics? a)
    (clr-is System.Net.NetworkInformation.Win32IcmpV6Statistics a))
  (define-field-port
    destination-unreachable-messages-received
    #f
